...
public class ColorPickerDialog 
        ...
        implements ColorListener, ColorProvider
{
    ...
    public ColorPickerDialog(Window parent, ColorPalette p) {
        ...
        cpp = new ColorPalettePanel(p);
        cpp.addColorListener(this);
    ...
    public void setColorProvider(ColorProvider cp) {
        throw new UnsupportedOperationException("ColorDialog is the last Color Provider"); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public void dispatchStrokeColor() {
        Color color = pnlResult.getBackground();
